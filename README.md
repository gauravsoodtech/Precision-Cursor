<div align="center">
  <img src="assets/logo.png" alt="DPI Assistant logo" width="170">
  <h1>DPI Assistant</h1>
  <p><strong>A lightweight Windows tray tool for clean horizontal, vertical, and 45-degree cursor movement.</strong></p>

  <p>
    <a href="https://github.com/gauravsoodtech/DPI-Assistant/actions/workflows/ci.yml"><img alt="CI" src="https://github.com/gauravsoodtech/DPI-Assistant/actions/workflows/ci.yml/badge.svg"></a>
...
For API and detection-surface details, see [docs/SECURITY_ANALYSIS.md](docs/SECURITY_ANALYSIS.md). If you find a security issue, please follow [SECURITY.md](SECURITY.md).

## Privacy

DPI Assistant runs locally and does not include telemetry or network features. See [docs/PRIVACY.md](docs/PRIVACY.md).

## License

DPI Assistant is released under the [MIT License](LICENSE).
